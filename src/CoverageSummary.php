...
class CoverageSummary implements \JsonSerializable
{
    ...
    /**
     * @param float|null $coverage Percentage of lines covered
     * @param int|null $total Total number of lines
     * @param int|null $executed Number of executed lines
     * @param int $files Number of files (optional, for directories)
     * @param int $lines Number of lines (optional, for directories)
     * @param float|null $fileCoverage Percentage of files covered (optional)
     */
    public function __construct(?float $coverage, ?int $total, ?int $executed, int $files = 0, int $lines = 0, ?float $fileCoverage = null)
    {
